...
def setup():
    ...
    if not os.path.isdir('monero'):
        subprocess.check_call(['git', 'clone', 'https://github.com/TheCharlatan/monero.git'])
...
def build():
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/monero*.tar.gz ../monerobinaries/'+args.version, shell=True)
